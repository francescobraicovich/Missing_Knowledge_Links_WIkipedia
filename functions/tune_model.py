...
def tune(X, y, space, scoring, 
         ...
         verbose=True, display_plots=0, refit=None):
    """
    ...
    if verbose:
        ...
        if type(result.scorer_) == type({}):
            ...
            # print the single metric
            print('Best Score (%s): %s' % (refit, result.best_score_))
    ...
    if modeltype == 'clf':
        ...
        # find false positive rate, true positive rate and thresholds
        ...
        best_params['threshold'] = optimal_threshold
